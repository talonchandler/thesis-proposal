...
% \bottomrule
% \end{tabularx}
%   \caption{Comparison of existing and proposed fluorescence orientation microscopy techniques. \xmark\ = poor or non-existent, \cmark = good, \cmark\cmark = excellent, \cmark\cmark\cmark = best in class.}
% \end{table}
...
% can be modified into a polarized single-view microscope by adding a polarizing
% filter to the illumination or detection path. After collecting intensity images
% under several polarizing filter orientations, the orientation of fluorophores
% can be reconstructed by applying simple image arithmetic to the set of
% images. Polarized single-view microscopes image quickly and gently---many
% live-cell biology applications already use these techniques---but they suffer
% from incomplete axial spatial and axial angular resolution.
...
%     \ganttbar[inline=false]{\textbf{Thesis}}{19}{24}
%   \end{ganttchart}
